...
<div class="section-title">
	...
	<h2><span>Search results for " <?php echo esc_html( get_search_query( true ) ); ?> "</span></h2>
		...
		<div class="row">
			<div class="col-md-5 wrapthumbnail">
				<a href="<?php the_permalink(); ?>">
					<div class="thumbnail" style="background-image:url(<?php echo get_theme_file_uri('/assets/img/demopic/1.jpg') ?>);">
					</div>
				</a>
			</div>
			<div class="col-md-7">
