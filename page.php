		...
		<div class="col-md-8 col-md-offset-2 col-xs-12">
			<div class="mainheading">
				...
				<div class="row post-top-meta">
					<div class="col-md-2">
						<a href="/author/<?php echo get_the_author_link() ?>"><img class="author-thumb" src="https://www.gravatar.com/avatar/e56154546cf4be74e393c62d1ae9f9d4?s=250&amp;d=mm&amp;r=x" alt="Sal"></a>
					</div>
					<div class="col-md-10">
						<a class="link-dark" href="/author/<?php echo get_the_author_link() ?>"><?php echo get_the_author(); ?></a><a href="<?php echo get_the_author_link() ?>" class="btn follow">Follow</a>
